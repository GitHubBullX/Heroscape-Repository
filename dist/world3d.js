...
let vertices=[],count=0,last=null,start=performance.now(),quality=devicePixelRatio>1.6&&innerWidth<800?.72:1;
...
window.Valhalla3D={render(data){last=data;rebuild(data)},setView(view){if(last)last.view=view},available:true};requestAnimationFrame(frame);
})();
